...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frecuen = frecuen = 106700000
        ...
        self.iio_pluto_source_0.set_frequency(frecuen)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_1.set_frequency_range(self.frecuen, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, self.samp_rate)

    def get_frecuen(self):
        return self.frecuen

    def set_frecuen(self, frecuen):
        self.frecuen = frecuen
        self.iio_pluto_source_0.set_frequency(self.frecuen)
        self.qtgui_sink_x_1.set_frequency_range(self.frecuen, self.samp_rate)
